...
class NotificationPlugin {
 ...
 //   tz.setLocalLocation(tz.getLocation(timeZoneName!));
  ...
  Future<void> scheduleNotification( int id, {required String titulo,  required String msg,
    required DateTime datanotificacao} ) async {
    tz.TZDateTime scheduleNotificationDateTime = tz.TZDateTime.from(datanotificacao, tz.local);
    print("DATA ${scheduleNotificationDateTime} - ${datanotificacao}");
    var androidChannelSpecifics = const AndroidNotificationDetails(
      'VETPET '  ,
      'VETPET' ,
      channelDescription:'VETPET ALERTAS' ,
      icon: 'app_icon',
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      scheduleNotificationDateTime,
        platformChannelSpecifics,
        payload: 'VETPET', androidAllowWhileIdle: true,
        uiLocalNotificationDateInterpretation: UILocalNotificationDateInterpretation.absoluteTime,
        matchDateTimeComponents: DateTimeComponents.time
    );
  }
/*
 ...
 //   var response = await http.get(url);
  ...
  Future<int> getPendingNotificationCount() async {
    ...
    developer.log( "${flutterLocalNotificationsPlugin.pendingNotificationRequests()}");
    return p.length;
  }
